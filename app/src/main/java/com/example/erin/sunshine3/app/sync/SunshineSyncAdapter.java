package com.example.erin.sunshine3.app.sync;
...
import com.example.erin.sunshine3.app.MainActivity;
import com.example.erin.sunshine3.app.R;
import com.example.erin.sunshine3.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor results = getContext().getContentResolver().query(
        ...
        if(results.moveToFirst()) {
            int columnIndex = results.getColumnIndex(WeatherContract.LocationEntry._ID);
            rowId = results.getLong(columnIndex);
        } else {
            ...
            rowId = ContentUris.parseId(locationUri);
        }
        results.close();
        return rowId;
    }
    ...
    private void notifyWeather() {
        ...
        if (!prefs.getBoolean(context.getString(R.string.pref_notify_key), true)) {
            return;
        }
