...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        mContext.deleteDatabase(com.example.erin.sunshine3.app.data.WeatherDbHelper.DATABASE_NAME);
    }
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("poop!", cursor, contentValues);
